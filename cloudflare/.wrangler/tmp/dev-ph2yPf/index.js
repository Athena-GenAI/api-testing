...
async function processPositionData(env) {
  const batchSize = 3;
  const timeout = 5e3;
  const traders = TRADER_WALLETS2.slice(0, 5);
  const protocols = SUPPORTED_PROTOCOLS2;
  const tokenStats = {};
...
// .wrangler/tmp/bundle-EOBwFI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EOBwFI/middleware-loader.entry.ts
