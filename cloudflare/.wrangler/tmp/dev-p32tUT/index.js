...
async function fetchPositionData(trader_id, protocol, env) {
  try {
    const url = `${COPIN_BASE_URL}/api/v1/positions/${protocol.toLowerCase()}/${trader_id}`;
...
// .wrangler/tmp/bundle-kTC8KV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kTC8KV/middleware-loader.entry.ts
